...
#import "MomentCreateViewController_old.h"
...
-(void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    int imageHeight = (int)[metaData valueForKey:@"DPIHeight"];
    int imageWidth = (int)[metaData valueForKey:@"DPIWidth"];
